...
def evaluate(
    ...
    """
    Evaluate a trained FAUDeepFakeRecognizer on the val or test split.
    """
    ...
    lit_model = FAUDeepFakeRecognizer.load_from_checkpoint(ckpt_path, map_location="cpu")
    lit_model.eval()
    ...
    typer.echo("\n" + "=" * 50)
    typer.echo(f"  FAU EVALUATION RESULTS ({split} split)")
    typer.echo("=" * 50)
