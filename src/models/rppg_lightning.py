...
import torchmetrics
from src.models.rppg_classifier import RPPGClassifier


class RPPGDeepFakeRecognizer(pl.LightningModule):
    def __init__(
        self,
        model_params: dict,
        lr: float = 1e-4,
        ...
        self.model = RPPGClassifier(**model_params)
    ...
    def configure_optimizers(self):
        encoder_params = list(self.model.phys_encoder.parameters())
