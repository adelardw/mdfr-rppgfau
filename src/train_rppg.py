...
def train(
    ...
    """
    Обучение RPPGDeepFakeRecognizer (только rPPG-энкодер) на видеодатасетах.
    """
    ...
    lit_model = RPPGDeepFakeRecognizer(model_params=model_cfg, **train_cfg)
    ...
    typer.echo("🚀 Запуск обучения RPPGDeepFakeRecognizer...")
